...
welcome(Req, State) ->
	...
	% Latest_News_Url = "http://api.contentapi.ws/news?channel=fashion&limit=2&skip=0&format=long",
	Latest_News_Url = "http://contentapi.ws:5984/contentapi_text_maxcdn/_design/yb_entertainment_people/_view/long?descending=true&limit=2&skip=0",
	...
	{ok, Body} = index_dtl:render([{<<"videoParam">>,Params},{<<"latestnews">>,LatestNewsParams},{<<"latestVideos">>,LatestVideosParams},{<<"latestPopularVideos">>,LatestPopularVideosParams},{<<"gallery">>,GalleryParams},{<<"latestbeautynews1">>,LatestBeautyNews1}]),
    {Body, Req, State}.
