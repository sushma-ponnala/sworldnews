...
welcome(Req, State) ->
	...
	{ok, Body} = beauty_dtl:render([{<<"videoParam">>,Params},{<<"newsParam">>,ParamsNews},{<<"latestVideos">>,LatestVideosParams},{<<"latestPopularVideos">>,LatestPopularVideosParams},{<<"gallery">>,GalleryParams},{<<"latestbeautynews1">>,LatestBeautyNews1}]),
    {Body, Req2, State}.
