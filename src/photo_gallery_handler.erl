...
welcome(Req, State) -> 
	...
	% Url_all_news = "http://api.contentapi.ws/news?channel=image_galleries&limit=15&skip=0&format=short",
	Url_all_news = "http://contentapi.ws:5984/contentapi_text_maxcdn/_design/yb_entertainment_music/_view/short?descending=true&limit=12&skip=0",
	...
	LatestBeautyNews1 = proplists:get_value(<<"rows">>, ResponseParams_Latest_Beauty_News1),
 	...
 	{ok, Body} = photo_gallery_dtl:render([{<<"videoParam">>,Params},{<<"allnews">>,ParamsAllNews},{<<"latestnews">>,LatestNewsParams},{<<"latestVideos">>,LatestVideosParams1},{<<"latestPopularVideos">>,LatestPopularVideosParams},{<<"gallery">>,GalleryParams},{<<"latestbeautynews1">>,LatestBeautyNews1}]),
 	{Body, Req, State}.	